...
| [sc-drum-synthesis](skills/sc-drum-synthesis/SKILL.md) | キック・スネア・クラップ・リム・ハットなどの音色設計、ビート、sidechain、継ぎ目のないループ、エフェクト処理、テンポ同期のSE(ダウンリフター、インパクト、ライザー)と808・シンセベース、リファレンス比較 |
